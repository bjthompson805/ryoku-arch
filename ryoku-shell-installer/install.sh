...
# RYOKU_SHELL_REPO points the payload clone at a different git remote.
set -euo pipefail

main() {
  local ref="${RYOKU_SHELL_REF:-main}"
  local raw="https://raw.githubusercontent.com/bjthompson805/ryoku-arch/${ref}/ryoku-shell-installer"
