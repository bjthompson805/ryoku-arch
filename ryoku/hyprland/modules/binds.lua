...
hl.bind(mod .. " + comma",     hl.dsp.exec_cmd("flock -n -o /tmp/ryoku-hub.lock env QS_APP_ID=ryoku-hub qs -c hub"))     -- ryoku settings
hl.bind(mod .. " + K",         hl.dsp.exec_cmd("ryoku-hub config set section keybinds; flock -n -o /tmp/ryoku-hub.lock env QS_APP_ID=ryoku-hub qs -c hub")) -- keybind reference (the live shortcut legend)
...
-- Brightness keys
hl.bind("XF86MonBrightnessUp",   hl.dsp.exec_cmd("ryoku-shell backlight up"),   { locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("ryoku-shell backlight down"), { locked = true, repeating = true })
